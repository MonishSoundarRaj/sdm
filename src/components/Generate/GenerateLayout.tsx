...
import { IconPlayerPlay, IconEye, IconDownload, IconDatabaseOff, IconLayoutList } from '@tabler/icons-react';
...
export function GenerateLayout() {
  ...
  return (
    <Container size="" className={classes.container}>
      ...
      <Paper shadow="sm" radius="md" withBorder className={`${classes.paper} ${classes.recentDataPaper}`} mt="lg">
        <Text weight={500} className={classes.sectionTitle}>
          Recently Generated Data
        </Text>
        {lastTwoRecentData.length > 0 ? (
          <Stack spacing="md">
          ...
          <Center style={{ height: '200px' }}>
            <Box className={classes.emptyState}>
              ...
              <Text size="xl" weight={500} mt="md">No recent data</Text>
